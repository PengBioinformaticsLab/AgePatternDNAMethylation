...
all_results <- extractResults("matrix/allTRUE.csv", "matrix/allFALSE.csv", 0.25)
male_results <- extractResults("matrix/maleTRUE.csv", "matrix/maleFALSE.csv", 0.2)
female_results <- extractResults("matrix/femaleTRUE.csv", "matrix/femaleFALSE.csv", 0.2)
...
# extract_sites(results, filtered_cpg_list, gender_state, cor_threshold, abs_threshold_young, abs_threshold_old, sd_threshold, extra_filter=TRUE)
...
all_sig_counts <- extract_sites(all_results, filtered_list, "Male", 0.5, 0.2, 0.1, 2, TRUE)
