...
metadata_tracker <- readRDS("metadata_tracker.rds")
...
# Everything below is retrospective
...
for (window in names(all_list)) {
  ...
  print(a)
  ggsave(a, filename=paste0(window, "_explot.png"), height = 12, width = 9, dpi=300)
...
GSE40279 <- fread("pp_datasets/GSE40279_pp.csv")
GSE53740 <- fread("pp_datasets/GSE53740_pp.csv")
