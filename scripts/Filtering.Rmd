...
# saveRDS(all_results, "../intermediates/filter/all_results.rds")
# saveRDS(male_results, "../intermediates/filter/male_results.rds")
# saveRDS(female_results, "../intermediates/filter/female_results.rds")
```
...
# load all results
all_results <- readRDS("../intermediates/filter/all_results.rds")
male_results <- readRDS("../intermediates/filter/male_results.rds")
female_results <- readRDS("../intermediates/filter/female_results.rds")
...
all_sig_counts    <- extract_sites(all_results,   filtered_list, "Male", 0.4, 0.1, 0.1, 2, TRUE)
male_sig_counts   <- extract_sites(male_results,  filtered_list, 2, 0.5, 0.2, 0.1, 2, TRUE)
female_sig_counts <- extract_sites(filtered_list, filtered_list, 3, 0.5, 0.25, 2, TRUE)
