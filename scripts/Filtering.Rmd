...
all_sig_counts    <- extract_sites(all_results,   filtered_list, "Male", 0.5, 0.2, 0.2, 2, TRUE)
male_sig_counts   <- extract_sites(male_results,  filtered_list, 2, 0.5, 0.2, 0.2, 2, TRUE)
female_sig_counts <- extract_sites(filtered_list, filtered_list, 3, 0.5, 0.2, 2, TRUE)
