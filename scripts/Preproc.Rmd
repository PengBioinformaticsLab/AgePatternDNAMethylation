...
file_path <- "../../data/raw/oGSE32148_beta.xlsx"
file_path2 <- "../data/raw/oGSE32148_md.xlsx"

temp_beta <- readXLSX(file_path)
temp_md <- readXLSX(file_path2)
...
# save processed data
#write.csv(new_dataset, "../../data/processed/GSE32148_pp.csv") # work-around to preserve rownames, when read using fread, rownames become the first column

# 2. GSE36054
# ------------------

file_path <- "../data/raw/oGSE36054_beta.xlsx"
file_path2 <- "../data/raw/oGSE36054_md.xlsx"
...
#write.csv(new_dataset, "../../data/processed/GSE36054_pp.csv")

# 3. GSE40279
# ------------------

file_path <- "../data/raw/oGSE40279_beta.csv"
file_path2 <- "../data/raw/oGSE40279_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE40279_pp.csv")

# 4. GSE50660
# ------------------

file_path <- "../data/raw/oGSE50660_beta.csv"
file_path2 <- "../data/raw/oGSE50660_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE50660_pp.csv")

# 5. GSE50759
# ------------------

file_path <- "../data/raw/oGSE50759_beta.xlsx"
file_path2 <- "../data/raw/oGSE50759_md.xlsx"
...
#write.csv(new_dataset, "../data/processed/GSE50759_pp.csv")

# 6. GSE51057
# ------------------

file_path <- "../data/raw/oGSE51057_beta.csv"
file_path2 <- "../data/raw/oGSE51057_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE51057_pp.csv")

# 7. GSE53740
# ------------------

file_path <- "../data/raw/oGSE53740_beta.csv"
file_path2 <- "../data/raw/oGSE53740_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE53740_pp.csv")

# 8. GSE61256
# ------------------

file_path <- "../data/raw/oGSE61256_beta.csv"
file_path2 <- "../data/raw/oGSE61256_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE61256_pp.csv")

# 9. GSE67705
# ------------------

file_path <- "../data/raw/oGSE67705_beta.csv"
file_path2 <- "../data/raw/oGSE67705_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE67705_pp.csv")

# 10. GSE73103
# ------------------

file_path <- "../data/raw/oGSE73103_beta.csv"
file_path2 <- "../data/raw/oGSE73103_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE73103_pp.csv")

# 11. GSE80261
# ------------------

file_path <- "../data/raw/oGSE80261_beta.xlsx"
file_path2 <- "../data/raw/oGSE80261_md.xlsx"
...
#write.csv(new_dataset, "../data/processed/GSE80261_pp.csv")

# 12. GSE85568
# ------------------

file_path <- "../data/raw/oGSE85568_beta.csv"
file_path2 <- "../data/raw/oGSE85568_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE85568_pp.csv")

# 13. GSE89253
# ------------------

file_path <- "../data/raw/oGSE89253_beta.csv"
file_path2 <- "../data/raw/oGSE89253_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE89253_pp.csv")

# 14. GSE90124
# ------------------

file_path <- "../data/raw/oGSE90124_beta.csv"
file_path2 <- "../data/raw/oGSE90124_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE90124_pp.csv")

# 15. GSE94734
# ------------------

file_path <- "../data/raw/oGSE94734_beta.xlsx"
file_path2 <- "../data/raw/oGSE94734_md.xlsx"
...
#write.csv(new_dataset, "../data/processed/GSE94734_pp.csv")

# 16. GSE106648
# ------------------

file_path <- "../data/raw/oGSE106648_beta.csv"
file_path2 <- "../data/raw/oGSE106648_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE106648_pp.csv")

# 17. GSE114134
# ------------------

file_path <- "../data/raw/oGSE114134_beta.csv"
file_path2 <- "../data/raw/oGSE114134_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE114134_pp.csv")
...
file_path <- "../data/raw/oGSE124366_beta.csv"
file_path2 <- "../data/raw/oGSE124366_md.csv"
...
#write.csv(new_dataset, "../data/processed/GSE124366_pp.csv")

# 19. GSE137495
# ------------------

file_path <- "../data/raw/oGSE137495_beta.xlsx"
file_path2 <- "../data/raw/oGSE137495_md.xlsx"
...
#write.csv(new_dataset, "../data/processed/GSE137495_pp.csv")

# 20. GSE138279
# ------------------

file_path <- "../data/raw/oGSE138279_beta.xlsx"
file_path2 <- "../data/raw/oGSE138279_md.xlsx"
...
#write.csv(new_dataset, "../data/processed/GSE138279_pp.csv")
...
#write.csv(new_dataset, "../data/processed/GSE62924_pp.csv")
...
#write.csv(new_dataset, "../data/processed/GSE51180_pp.csv")
...
#write.csv(new_dataset, "../data/processed/GSE30870_pp.csv")
...
clock_cpg_list <- running_site_list[clock_cpgs, , drop=FALSE]

# NEED TO DO: MODIFY ABOVE PIPELINE SO RUNNING_SITE_LIST COUNTS NUMBER OF SAMPLES CPG HAS VALID ENTRY IN
...
cpg_list <- readRDS("all_high_presence_cpgs.rds")
full_metadata <- readRDS("full_metadata.rds")
valid_samples <- readRDS("valid_samples.rds")
output_folder <- "splits/"
...
ggsave(
  filename = "new_figs/supp_fig5.pdf", 
  plot     = supp_fig5, 
  width    = 8, 
  height   = 10, 
  dpi      = 300
...
GSE40279 <- fread("../data/processed/GSE40279_pp.csv")
GSE53740 <- fread("../data/processed/GSE53740_pp.csv")
